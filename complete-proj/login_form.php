<?php
  ...
  if(isset($_SESSION['login_user'])){
      echo "<script type='text/javascript'>document.location.href='https://proj-onestop-electronics.000webhostapp.com/login_func.php';</script>";
      exit();
  }
?>   
    ...
    <div class="account-form">
      <div class="login-container">
        <form action="login_func.php" method="POST">
          ...
          <input type="text" name="cus_username" placeholder="Username" /> 
          <br />
          <i class="bi bi-lock"></i>
          <input type="password" name="password" placeholder="Password"/>
          <br />
          <p>Don't have an account? Click here to <a href="registration_form.php">Register.</a></p>
